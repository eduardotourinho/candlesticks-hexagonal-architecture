...
### Requirements
The main requirement is the aggregated price history endpoint.
It should provide 30 minutes quotes history in the form of minute candlesticks (check information below) for any requested instrument.
